...
class Post extends Model {
	...
	public static function getSinglePost($id) //使用db方式获得文章返回给控制器
	{
			$post=DB::table('b_article')
					->leftJoin('b_user','b_article.userId','=','b_user.id')
					->leftJoin('b_category','b_article.categoryId','=','b_category.id')
					->select('b_article.id','b_article.title','b_article.content','b_article.excerpt','b_user.name','b_category.name','b_article.tag','b_article.type','b_article.createDate','b_article.view','b_article.userId')
