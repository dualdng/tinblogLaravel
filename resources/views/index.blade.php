...
<div class="bgImg">
		...
		<script>
				$(document).ready(function(){
						$('#typer').typeTo('<?php echo $line;?>');
				})
		</script>
</div>
<div class='container text-center scrollDown'>
		<a href='javascript:void(0)' onclick='scrollDown()'><span class='glyphicon glyphicon-chevron-down'></span></a>
</div>
@endsection
